...
input_field=Entry(input_frame,font=("arail",18,"bold"),width=45,justify=RIGHT,textvariable=input)
...
#Button fifth row
zero=Button(btns_frame,text="0",width=24,height=3,command=lambda: btn_click(0)).grid((row=4,column=0,padx=1,pady=1))
